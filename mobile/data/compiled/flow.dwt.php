...
?> 
        ...
        <div class="desc new-tbl-cell"> <a style="color:#333" href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="fragment">
          ...
          <div class="b"> <em class="price"><?php echo $this->_var['goods']['goods_price']; ?></em> <span style="jianju">x </span> <span class="txt"> 
            ...
            <input class="inputBg" type="number" min="1" max="1000" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4"   onkeyup="changenum(<?php echo $this->_var['goods']['rec_id']; ?>)"/>
...
<footer class="toolbar">
  ...
  <a href="flow.php?step=checkout">结算(<em class="num" id="total_number"><?php echo $this->_var['total']['real_goods_count']; ?></em>)</a> </footer>
<?php else: ?>
<section class="wrap"  >
