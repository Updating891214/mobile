...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      ...
      <ul>
        <li><a href="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods']['original_img']; ?>"><img alt="" src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods']['original_img']; ?>"/></a></li>
...
?> 
        ...
        <li><a href="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['picture']['img_url']; ?>"><img alt="" src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['picture']['img_url']; ?>"/></a></li>
        <?php endif; ?> 
...
<section class="goodsInfo">
  ...
  <div class="title">
    <h1> <?php echo $this->_var['goods']['goods_style_name']; ?></br></h1>	 <?php if ($this->_var['goods']['goods_brief']): ?>
	 <div class="brief"><font style="color:#FF0000;"><?php echo $this->_var['goods']['goods_brief']; ?></font></div>
	 <?php endif; ?> 
    </li>
  </div>
  <ul>
...
<li>
  ...
  <?php endif; ?>
  <ul>
    <li><?php if ($this->_var['goods']['goods_number'] != "" && $this->_var['cfg']['show_goodsnumber']): ?> 
                    ...
                    <?php else: ?> 
                    <?php echo $this->_var['lang']['goods_number']; ?>
                    <?php echo $this->_var['goods']['goods_number']; ?> <?php echo $this->_var['goods']['measure_unit']; ?>件
                    <?php endif; ?> 
...
?>
	...
	<?php echo $this->fetch('library/goods_chicun.lbi'); ?>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      ...
      <li id="tabs3" onClick="tab(3)" class=""> 评价 <span class="review-count">(<?php echo $this->_var['goods']['comment_count']; ?>)</span> </li>
...
?>
       ...
       <dt><span><?php echo htmlspecialchars($this->_var['property']['name']); ?>：</span></dt>
         <dd><span><?php echo $this->_var['property']['value']; ?></span></dd>
          </dl>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </div>
