      ...
      <ul style="height:25rem">
        ...
        <form action="user.php" method="post" name="formUser" onsubmit="return register();">
          ...
          <div class="table_box">
            <dl>
              <dd>
                <input placeholder="请输入用户名（手机号码）" class="inputBg" name="username" id="username" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
                <input placeholder="请输入电子邮箱（选填）" class="inputBg" name="email" id="email" type="text" />
              </dd>
            </dl>
            <dl>
              <dd>
