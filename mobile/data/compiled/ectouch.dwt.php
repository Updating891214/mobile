...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"<?php echo $_GET['content']; ?>","bdMini":"2","bdMiniList":false,"bdPic":"<?php echo $this->_var['shop_url']; ?><?php echo $_GET['pic']; ?>","bdUrl":"<?php echo $this->_var['HTTP_REFERER']; ?>?u=<?php echo $_SESSION['user_id']; ?>","bdStyle":"1","bdSize":"32"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script> 
<?php endif; ?> 
