       ...
       <div id="pagebar" class="f_r">
        ...
        <div id="pager" style="padding:10px 0">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span>  <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a>  </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_57807500_1486632498');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_57807500_1486632498']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_57807500_1486632498']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
 ...
 <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="" >
     ...
     <tr>
          ...
          <td>
          <input name="comment_rank" type="radio" value="1" checked="checked" id="comment_rank5" /> 非常好
          <input name="comment_rank" type="radio" value="2" id="comment_rank4" /> 很好
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" /> 一般
          <input name="comment_rank" type="radio" value="4" id="comment_rank2" /> 不行
          <input name="comment_rank" type="radio" value="5" id="comment_rank1" /> 很差
          </td>
        </tr>
          <td>
        ...
        <tr>
          ...
          <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" onClick="this.src='captcha.php?'+Math.random()" class="captcha" style="height:34px; vertical-align:middle" /></td>
        </tr>
        <?php endif; ?>
        <tr>
...
<script type="text/javascript">
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_57861400_1486632498');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_57861400_1486632498']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_57861400_1486632498']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
