...
$config['site_name'] = '南京买菜网'; //站点名称

$config['site_url']='http://xinbuy.com.cn/'; //电脑版地址

$config['site_email'] = 'admin@025maicai.com'; //管理员邮箱

$config['site_phone'] = '025-84757518'; //公司电话

$config['site_fax'] = '021-68686868-801'; //传真号码

$config['site_address'] = '南京雨花区福升农贸市场'; //公司地址

$config['site_postcode'] = '210000'; //公司邮编

$config['site_image_maxwidth'] = '600'; //内容图片最大宽度

$config['site_summary_length'] = '360'; //内容摘要长度

$config['site_copyright'] = 'Copyright © 2014 南京雨花区福升农贸市场管理有限公司, All Rights Reserved'; //版权信息

$config['site_statcode'] = ''; //第三方统计代码

$config['site_icp'] = '苏ICP备13039735号'; //ICP 备案信息

$config['site_title'] = '南京雨花区福升农贸市场管理有限公司'; //首页标题
...
$config['SMTP_USERNAME'] = '373813888@qq.com'; //smtp服务器帐号，如：你的qq邮箱

$config['SMTP_PASSWORD'] = 'hua2014888'; //smtp服务器帐号密码，如你的qq邮箱密码

$config['SMTP_FROM_TO'] = '373813888@qq.com'; //发件人邮件地址
