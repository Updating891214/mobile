<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:62:"F:/phpStudy/WWW/bianli100/mobile/themes/bianli100/category.dwt";i:1;s:72:"F:/phpStudy/WWW/bianli100/mobile/themes/bianli100/library/goods_list.lbi";i:2;s:73:"F:/phpStudy/WWW/bianli100/mobile/themes/bianli100/library/page_footer.lbi";}s:7:"expires";i:1486636172;s:8:"maketime";i:1486632572;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>化妆品_日用百货_最模板zuimoban.com-方便100网上超市，鼠标购物，购物即时送，克拉玛依外卖实体店、网购、微信购，克拉玛依鼠标超市便利店 </title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      <li class=""> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=10&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/bianli100/images/loader.gif" /></div>'})
