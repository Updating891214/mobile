...
//JS語言項
$_LANG['booking_js']['booking_amount_empty'] = '请输入您要顶都的商品数据！';
...
//add by Lei W.
$_LANG['booking_js']['invite_empty'] = '请输入邀请码';
$_LANG['booking_js']['invite_error'] = '您输入的邀请码不存在！';
//
$_LANG['booking_js']['email_error'] = '您輸入的電子郵件地址格式不正確您输入的电子邮件！';
